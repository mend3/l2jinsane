...
public class HomeComunityBoard extends AbstractMods {
    ...
    private static String infoVoteReward() {
        ...
        for (Map.Entry<Integer, RewardHolder> entry : ConfigData.VOTE_REWARDS.entrySet()) {
            ...
            hb.append(Html.newFontColor("LEVEL", "Votos"), ": ", Integer.valueOf(voteCount), "<br1>");
            hb.append(Html.newFontColor("LEVEL", "Premios"), ": ", ItemTable.getInstance().getTemplate(reward.getRewardId()).getName(), " - ", Integer.valueOf(reward.getRewardCount()), "<br1>");
        }
        hb.append(Html.newImage("L2UI.SquareGray", 204, 1));
        return hb.toString();
    }
    ...
    private static String infoVip() {
        ...
        hb.append("<td fixwidth=104 align=center><font color=LEVEL>", Integer.valueOf((int) ConfigData.VIP_BONUS_XP + 100), "%</font></td>");
        hb.append("</tr>");
        hb.append("<tr>");
        hb.append("<td fixwidth=100 align=center><font color=3366FF>SP:</font></td>");
        hb.append("<td fixwidth=104 align=center><font color=LEVEL>", Integer.valueOf((int) ConfigData.VIP_BONUS_SP + 100), "%</font></td>");
        hb.append("</tr>");
        hb.append("</table>");
        hb.append(Html.newImage("L2UI.SquareGray", 204, 1));
        ...
        hb.append("<td fixwidth=52 align=center><font color=LEVEL>", Integer.valueOf((int) ConfigData.VIP_BONUS_DROP_NORMAL_AMOUNT + 100), "%</font></td>");
        hb.append("<td fixwidth=52 align=center><font color=LEVEL>", Integer.valueOf((int) ConfigData.VIP_BONUS_DROP_NORMAL_AMOUNT + 100), "%</font></td>");
        hb.append("</tr>");
        hb.append("<tr>");
        hb.append("<td fixwidth=100 align=center><font color=3366FF>Spoil:</font></td>");
        hb.append("<td fixwidth=52 align=center><font color=LEVEL>", Integer.valueOf((int) ConfigData.VIP_BONUS_DROP_SPOIL_AMOUNT + 100), "%</font></td>");
        hb.append("<td fixwidth=52 align=center><font color=LEVEL>", Integer.valueOf((int) ConfigData.VIP_BONUS_DROP_SPOIL_CHANCE + 100), "%</font></td>");
        hb.append("</tr>");
        hb.append("<tr>");
        hb.append("<td fixwidth=100 align=center><font color=3366FF>Seed:</font></td>");
        hb.append("<td fixwidth=52 align=center><font color=LEVEL>", Integer.valueOf((int) ConfigData.VIP_BONUS_DROP_SEED_AMOUNT + 100), "%</font></td>");
        hb.append("<td fixwidth=52 align=center><font color=LEVEL>", Integer.valueOf((int) ConfigData.VIP_BONUS_DROP_SEED_AMOUNT + 100), "%</font></td>");
        hb.append("</tr>");
        hb.append("<tr>");
        hb.append("<td fixwidth=100 align=center><font color=3366FF>Herb:</font></td>");
        hb.append("<td fixwidth=52 align=center><font color=LEVEL>", Integer.valueOf((int) ConfigData.VIP_BONUS_DROP_HERB_AMOUNT + 100), "%</font></td>");
        hb.append("<td fixwidth=52 align=center><font color=LEVEL>", Integer.valueOf((int) ConfigData.VIP_BONUS_DROP_HERB_AMOUNT + 100), "%</font></td>");
        hb.append("</tr>");
        hb.append("</table>");
        hb.append(Html.newImage("L2UI.SquareGray", 204, 1));
    ...
    private static String infoEnchant() {
        ...
        hb.append("<tr>");
        hb.append("<td fixwidth=100 align=center><font color=3366FF>Normal:</font></td>");
        hb.append("<td fixwidth=52 align=center><font color=LEVEL>", Integer.valueOf(45), "%</font></td>");
        hb.append("<td fixwidth=52 align=center><font color=LEVEL>", Integer.valueOf(75), "%</font></td>");
        hb.append("</tr>");
        hb.append("<tr>");
        hb.append("<td fixwidth=100 align=center><font color=3366FF>Bless:</font></td>");
        hb.append("<td fixwidth=52 align=center><font color=LEVEL>", Integer.valueOf(75), "%</font></td>");
        hb.append("<td fixwidth=52 align=center><font color=LEVEL>", Integer.valueOf(85), "%</font></td>");
        hb.append("</tr>");
        hb.append("<tr>");
        hb.append("<td fixwidth=100 align=center><font color=3366FF>Crytal:</font></td>");
        hb.append("<td fixwidth=52 align=center><font color=LEVEL>", Integer.valueOf(85), "%</font></td>");
        hb.append("<td fixwidth=52 align=center><font color=LEVEL>", Integer.valueOf(100), "%</font></td>");
        hb.append("</tr>");
        hb.append("</table>");
        hb.append(Html.newImage("L2UI.SquareGray", 204, 1));
        return hb.toString();
    ...
    private static String infoRates() {
        ...
        hb.append("<tr>");
        hb.append("<td fixwidth=100 align=center><font color=3366FF>EXP:</font></td>");
        hb.append("<td fixwidth=104 align=center><font color=LEVEL>", Double.valueOf(Config.RATE_XP), "%</font></td>");
        hb.append("</tr>");
        hb.append("<tr>");
        hb.append("<td fixwidth=100 align=center><font color=3366FF>SP:</font></td>");
        hb.append("<td fixwidth=104 align=center><font color=LEVEL>", Double.valueOf(Config.RATE_SP), "%</font></td>");
        hb.append("</tr>");
        hb.append("</table>");
        hb.append(Html.newImage("L2UI.SquareGray", 204, 1));
        ...
        hb.append("<td fixwidth=104 align=center><font color=LEVEL>", Double.valueOf(Config.RATE_DROP_ADENA), "%</font></td>");
        hb.append("</tr>");
        hb.append("<tr>");
        hb.append("<td fixwidth=100 align=center><font color=3366FF>Drop:</font></td>");
        hb.append("<td fixwidth=104 align=center><font color=LEVEL>", Double.valueOf(Config.RATE_DROP_ITEMS), "%</font></td>");
        hb.append("</tr>");
        hb.append("<tr>");
        hb.append("<td fixwidth=100 align=center><font color=3366FF>Spoil:</font></td>");
        hb.append("<td fixwidth=104 align=center><font color=LEVEL>", Double.valueOf(Config.RATE_DROP_SPOIL), "%</font></td>");
        hb.append("</tr>");
        hb.append("</table>");
        hb.append(Html.newImage("L2UI.SquareGray", 204, 1));
        return hb.toString();
