...
public class DayNightManager {
    ...
    public void spawnCreatures(boolean isNight) {
        List<L2Spawn> creaturesToUnspawn = isNight ? this._dayCreatures : this._nightCreatures;
        List<L2Spawn> creaturesToSpawn = isNight ? this._nightCreatures : this._dayCreatures;
