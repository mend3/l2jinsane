...
public class NpcData implements IXmlReader {
    ...
    public void parseDocument(Document doc, Path path) {
        this.forEach(doc, "list", (listNode) -> this.forEach(listNode, "npc", (npcNode) -> {
            ...
            this.forEach(npcNode, "teachTo", (teachToNode) -> set.set("teachTo", this.parseString(teachToNode.getAttributes(), "classes")));
    ...
    public NpcTemplate getTemplateByName(String name) {
        return this._npcs.values().stream().filter((t) -> t.getName().equalsIgnoreCase(name)).findFirst().orElse(null);
    }
