...
public class DoorData implements IXmlReader {
    ...
    public void parseDocument(Document doc, Path path) {
        this.forEach(doc, "list", (listNode) -> this.forEach(listNode, "door", (doorNode) -> {
            StatSet set = this.parseAttributes(doorNode);
            int id = set.getInteger("id");
            this.forEach(doorNode, "castle", (castleNode) -> set.set("castle", this.parseString(castleNode.getAttributes(), "id")));
            ...
            this.forEach(doorNode, "coordinates", (coordinatesNode) -> this.forEach(coordinatesNode, "loc", (locNode) -> {
            ...
            this.forEach(doorNode, "stats|function", (node) -> set.putAll(this.parseAttributes(node)));
