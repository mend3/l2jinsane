...
public class ClanBBSManager extends BaseBBSManager {
    private static void sendClanMail(Player player, int clanId) {
        ...
        String content = HtmCache.getInstance().getHtm("data/html/CommunityBoard/clan/clanhome-mail.htm");
    ...
    private static void sendClanManagement(Player player, int clanId) {
        ...
        String content = HtmCache.getInstance().getHtm("data/html/CommunityBoard/clan/clanhome-management.htm");
    ...
    private static void sendClanNotice(Player player, int clanId) {
        ...
        String content = HtmCache.getInstance().getHtm("data/html/CommunityBoard/clan/clanhome-notice.htm");
        content = content.replaceAll("%clanid%", Integer.toString(clan.getClanId()));
    ...
    private static void sendClanList(Player player, int index) {
        String content = HtmCache.getInstance().getHtm("data/html/CommunityBoard/clan/clanlist.htm");
    ...
    private static void sendClanDetails(Player player, int clanId) {
        ...
        if (player.getClanId() != clanId) {
            content = HtmCache.getInstance().getHtm("data/html/CommunityBoard/clan/clanhome.htm");
        } else if (player.isClanLeader()) {
            content = HtmCache.getInstance().getHtm("data/html/CommunityBoard/clan/clanhome-leader.htm");
        } else {
            content = HtmCache.getInstance().getHtm("data/html/CommunityBoard/clan/clanhome-member.htm");
        }
        content = content.replaceAll("%clanid%", Integer.toString(clan.getClanId()));
    ...
    public void parseCmd(String command, Player player) {
        if (command.equalsIgnoreCase("_bbsclan")) {
            ...
            st.nextToken();
            String clanCommand = st.nextToken();
            if (clanCommand.equalsIgnoreCase("clan")) {
                ...
                if (st.hasMoreTokens()) {
                    String noticeCommand = st.nextToken();
