    ...
    public boolean useUserCommand(int id, Player activeChar) {
        ...
        for (Castle castle : CastleManager.getInstance().getCastles()) {
            ...
            for (Player member : clan.getOnlineMembers()) {
                StringUtil.append(sb, "<tr><td width=170>", member.getName(), "</td><td width=100>", castle.getSiegeZone().isInsideZone(member) ? "Castle Siege in Progress" : "Outside Castle Siege Zone", "</td></tr>");
            }
