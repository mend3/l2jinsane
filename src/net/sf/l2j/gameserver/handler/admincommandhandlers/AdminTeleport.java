...
public class AdminTeleport implements IAdminCommandHandler {
    private static final String[] ADMIN_COMMANDS = new String[]{
            "admin_runmod", "admin_instant_move", "admin_tele", "admin_tele_areas", "admin_goto", "admin_teleportto", "admin_recall", "admin_recall_party", "admin_recall_clan", "admin_move_to",
            "admin_sendhome"};
