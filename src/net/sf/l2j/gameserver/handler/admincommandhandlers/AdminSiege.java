...
public class AdminSiege implements IAdminCommandHandler {
    private static final String[] ADMIN_COMMANDS = new String[]{
            "admin_siege", "admin_add_attacker", "admin_add_defender", "admin_list_siege_clans", "admin_clear_siege_list", "admin_move_defenders", "admin_spawn_doors", "admin_endsiege", "admin_startsiege", "admin_setcastle",
            "admin_removecastle", "admin_reset_certificates"};
    ...
    public boolean useAdminCommand(String command, Player activeChar) {
        try {
            ...
            for (TowerSpawnLocation spawn : castle.getControlTowers()) {
                String teleLoc = spawn.toString().replaceAll(",", "");
