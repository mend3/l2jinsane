...
public class AdminSkill implements IAdminCommandHandler {
    ...
    private static final String[] ADMIN_COMMANDS = new String[]{
            "admin_show_skills", "admin_remove_skills", "admin_skill_list", "admin_skill_index", "admin_add_skill", "admin_remove_skill", "admin_get_skills", "admin_reset_skills", "admin_give_all_skills", "admin_remove_all_skills",
            "admin_add_clan_skill", "admin_st"};
    ...
    private static void adminRemoveSkill(Player activeChar, int idval) {
        ...
        L2Skill skill = player.removeSkill(idval, true);
        if (skill == null) {
            activeChar.sendMessage("Error: there is no such skill.");
        } else {
