...
public class Q126_TheNameOfEvil_2 extends Quest {
    ...
    public Q126_TheNameOfEvil_2() {
        ...
        addStartNpc(32115);
        addTalkId(32115, 32114, 32119, 32120, 32121, 32122, 32109);
    }
    ...
    public final String onAdvEvent(String event, Npc npc, Player player) {
        ...
        QuestState st = player.getQuestState("Q126_TheNameOfEvil_2");
        if (st == null)
            return htmltext;
    ...
    public String onTalk(Npc npc, Player player) {
        ...
        switch (st.getState()) {
            case 0:
                ...
                st2 = player.getQuestState("Q125_TheNameOfEvil_1");
