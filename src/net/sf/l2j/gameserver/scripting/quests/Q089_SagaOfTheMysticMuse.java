...
public class Q089_SagaOfTheMysticMuse extends SagasSuperClass {
    public Q089_SagaOfTheMysticMuse() {
        ...
        this.NPC = new int[]{
                30174, 31627, 31283, 31283, 31643, 31646, 31648, 31651, 31654, 31655,
                31658, 31283};
        this.Items = new int[]{
                7080, 7530, 7081, 7504, 7287, 7318, 7349, 7380, 7411, 7442,
                7083, 0};
        this.Mob = new int[]{27251, 27238, 27255};
        this.classid = 103;
        this.prevclass = 27;
        this.X = new int[]{119518, 181227, 181215};
        this.Y = new int[]{-28658, 36703, 36676};
