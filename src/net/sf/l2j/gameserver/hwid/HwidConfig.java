...
import net.sf.l2j.gameserver.hwid.crypt.FirstKey;
...
public class HwidConfig {
    ...
    private static final Logger LOGGER = Logger.getLogger(HwidConfig.class.getName());
    ...
    public static boolean PROTECT_HWID_PARTY_ZONE;
    public static boolean PROTECT_HWID_AUTOFARM_ZONE;
    public static int PROTECT_WINDOWS_COUNT;

    public static void load() {
        File fp = new File("./config/hwid.properties");
        ...
        if (ALLOW_GUARD_SYSTEM)
            try {
                ...
                try {
                    ...
                    is.close();
                    LOGGER.info("- Loading HWID Configs");
                    ...
                    PROTECT_HWID_PARTY_ZONE = getBooleanProperty(guardSettings, "UseHWIDinPartyZone", false);
                    PROTECT_HWID_AUTOFARM_ZONE = getBooleanProperty(guardSettings, "UseHWIDinAutoFarmZone", false);
                    is.close();
