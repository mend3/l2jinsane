...
abstract class DocumentBase {
    ...
    protected void attachFunc(Node n, Object template, String function, Condition attachCond) {
        ...
        final FuncTemplate ft = new FuncTemplate(attachCond, applyCond, function, stat, value, lambda);
    ...
    protected void attachEffect(Node n, Object template, Condition attachCond) {
        ...
        lt = new EffectTemplate(attachCond, null, name, lambda, count, time, abnormal, stackType, stackOrder, icon, effectPower, type, trigId, trigLvl, chance);
