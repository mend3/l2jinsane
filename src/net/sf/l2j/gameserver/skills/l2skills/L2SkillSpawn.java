    ...
    public void useSkill(Creature caster, WorldObject[] targets) {
        if (!caster.isAlikeDead()) {
            if (this._npcId == 0) {
                ...
                if (template == null) {
                    int var10001 = this._npcId;
                    _log.warning("Spawn of the nonexisting NPC ID: " + var10001 + ", skill ID: " + this.getId());
                } else {
                    try {
                        ...
                        _log.log(Level.WARNING, "Exception while spawning NPC ID: " + var10002 + ", skill ID: " + this.getId() + ", exception: " + e.getMessage(), e);
                    }
