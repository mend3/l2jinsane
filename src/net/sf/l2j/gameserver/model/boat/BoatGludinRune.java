...
public class BoatGludinRune implements Runnable {
    ...
    private static final BoatLocation[] GLUDIN_TO_RUNE = new BoatLocation[]{
            new BoatLocation(-95686, 155514, -3610, 150, 800), new BoatLocation(-98112, 159040, -3610, 150, 800), new BoatLocation(-104192, 160608, -3610, 200, 1800), new BoatLocation(-109952, 159616, -3610, 250, 1800), new BoatLocation(-112768, 154784, -3610, 290, 1800), new BoatLocation(-114688, 139040, -3610, 290, 1800), new BoatLocation(-115232, 134368, -3610, 290, 1800), new BoatLocation(-113888, 121696, -3610, 290, 1800), new BoatLocation(-107808, 104928, -3610, 290, 1800), new BoatLocation(-97152, 75520, -3610, 290, 800),
            new BoatLocation(-85536, 67264, -3610, 290, 1800), new BoatLocation(-64640, 55840, -3610, 290, 1800), new BoatLocation(-60096, 44672, -3610, 290, 1800), new BoatLocation(-52672, 37440, -3610, 290, 1800), new BoatLocation(-46144, 33184, -3610, 290, 1800), new BoatLocation(-36096, 24928, -3610, 290, 1800), new BoatLocation(-33792, 8448, -3610, 290, 1800), new BoatLocation(-23776, 3424, -3610, 290, 1000), new BoatLocation(-12000, -1760, -3610, 290, 1000), new BoatLocation(672, 480, -3610, 290, 1800),
            new BoatLocation(15488, 200, -3610, 290, 1000), new BoatLocation(24736, 164, -3610, 290, 1000), new BoatLocation(32192, -1156, -3610, 290, 1000), new BoatLocation(39200, -8032, -3610, 270, 1000), new BoatLocation(44320, -25152, -3610, 270, 1000), new BoatLocation(40576, -31616, -3610, 250, 800), new BoatLocation(36819, -35315, -3610, 220, 800)};

    private static final BoatLocation[] RUNE_DOCK = new BoatLocation[]{new BoatLocation(34381, -37680, -3610, 200, 800)};

    private static final BoatLocation[] RUNE_TO_GLUDIN = new BoatLocation[]{
            new BoatLocation(32750, -39300, -3610, 150, 800), new BoatLocation(27440, -39328, -3610, 180, 1000), new BoatLocation(21456, -34272, -3610, 200, 1000), new BoatLocation(6608, -29520, -3610, 250, 800), new BoatLocation(4160, -27828, -3610, 270, 800), new BoatLocation(2432, -25472, -3610, 270, 1000), new BoatLocation(-8000, -16272, -3610, 220, 1000), new BoatLocation(-18976, -9760, -3610, 290, 800), new BoatLocation(-23776, 3408, -3610, 290, 800), new BoatLocation(-33792, 8432, -3610, 290, 800),
            new BoatLocation(-36096, 24912, -3610, 290, 800), new BoatLocation(-46144, 33184, -3610, 290, 800), new BoatLocation(-52688, 37440, -3610, 290, 800), new BoatLocation(-60096, 44672, -3610, 290, 800), new BoatLocation(-64640, 55840, -3610, 290, 800), new BoatLocation(-85552, 67248, -3610, 290, 800), new BoatLocation(-97168, 85264, -3610, 290, 800), new BoatLocation(-107824, 104912, -3610, 290, 800), new BoatLocation(-102151, 135704, -3610, 290, 800), new BoatLocation(-96686, 140595, -3610, 290, 800),
            new BoatLocation(-95686, 147717, -3610, 250, 800), new BoatLocation(-95686, 148218, -3610, 200, 800)};
    ...
    public BoatGludinRune(Boat boat) {
        ...
        this.LEAVING_GLUDIN = new CreatureSay(0, 11, 801, SystemMessageId.DEPARTURE_FOR_RUNE_NOW);
        ...
        this.RUNE_SOUND = new PlaySound(0, "itemsound.ship_arrival_departure", this._boat);
        ...
        this.RUNE_SOUND_LEAVE_5MIN = new PlaySound(0, "itemsound.ship_5min", this._boat);
        this.RUNE_SOUND_LEAVE_1MIN = new PlaySound(0, "itemsound.ship_1min", this._boat);
    }

    public static void load() {
        Boat boat = BoatManager.getInstance().getNewBoat(3, -95686, 150514, -3610, 16723);
        if (boat != null) {
    ...
    public void run() {
        switch (this._cycle) {
            ...
            case 1:
                ...
                ThreadPool.schedule(this, 60000L);
                break;
            case 2:
                ...
                this._boat.payForRide(7905, 1, OUST_LOC_1);
                this._boat.executePath(GLUDIN_TO_RUNE);
                ThreadPool.schedule(this, 250000L);
                break;
            case 3:
            ...
            case 6:
                ...
                break;
            case 7:
                if (BoatManager.getInstance().isBusyDock(2)) {
                ...
                BoatManager.getInstance().dockBoat(2, true);
            ...
            case 9:
                ...
                this._boat.broadcastPacket(this.RUNE_SOUND_LEAVE_5MIN);
                ThreadPool.schedule(this, 240000L);
                break;
            case 10:
                BoatManager.getInstance().broadcastPacket(RUNE_DOCK[0], GLUDIN_DOCK[0], this.LEAVE_RUNE1);
                this._boat.broadcastPacket(this.RUNE_SOUND_LEAVE_1MIN);
