...
public class BoatGiranTalking implements Runnable {
    ...
    private static final BoatLocation[] GIRAN_TO_TALKING = new BoatLocation[]{
            new BoatLocation(51914, 189023, -3610, 150, 800), new BoatLocation(60567, 189789, -3610, 150, 800), new BoatLocation(63732, 197457, -3610, 200, 800), new BoatLocation(63732, 219946, -3610, 250, 800), new BoatLocation(62008, 222240, -3610, 250, 1200), new BoatLocation(56115, 226791, -3610, 250, 1200), new BoatLocation(40384, 226432, -3610, 300, 800), new BoatLocation(37760, 226432, -3610, 300, 800), new BoatLocation(27153, 226791, -3610, 300, 800), new BoatLocation(12672, 227535, -3610, 300, 800),
            new BoatLocation(-1808, 228280, -3610, 300, 800), new BoatLocation(-22165, 230542, -3610, 300, 800), new BoatLocation(-42523, 235205, -3610, 300, 800), new BoatLocation(-68451, 259560, -3610, 250, 800), new BoatLocation(-70848, 261696, -3610, 200, 800), new BoatLocation(-83344, 261610, -3610, 200, 800), new BoatLocation(-88344, 261660, -3610, 180, 800), new BoatLocation(-92344, 261660, -3610, 180, 800), new BoatLocation(-94242, 261659, -3610, 150, 800)};

    private static final BoatLocation[] TALKING_DOCK = new BoatLocation[]{new BoatLocation(-96622, 261660, -3610, 150, 800)};

    private static final BoatLocation[] TALKING_TO_GIRAN = new BoatLocation[]{
            new BoatLocation(-113925, 261660, -3610, 150, 800), new BoatLocation(-126107, 249116, -3610, 180, 800), new BoatLocation(-126107, 234499, -3610, 180, 800), new BoatLocation(-126107, 219882, -3610, 180, 800), new BoatLocation(-109414, 204914, -3610, 180, 800), new BoatLocation(-92807, 204914, -3610, 180, 800), new BoatLocation(-80425, 216450, -3610, 250, 800), new BoatLocation(-68043, 227987, -3610, 250, 800), new BoatLocation(-63744, 231168, -3610, 250, 800), new BoatLocation(-60844, 231369, -3610, 250, 1800),
            new BoatLocation(-44915, 231369, -3610, 200, 800), new BoatLocation(-28986, 231369, -3610, 200, 800), new BoatLocation(8233, 207624, -3610, 200, 800), new BoatLocation(21470, 201503, -3610, 180, 800), new BoatLocation(40058, 195383, -3610, 180, 800), new BoatLocation(43022, 193793, -3610, 150, 800), new BoatLocation(45986, 192203, -3610, 150, 800), new BoatLocation(48950, 190613, -3610, 150, 800)};
    ...
    public BoatGiranTalking(Boat boat) {
        ...
        this.GIRAN_SOUND = new PlaySound(0, "itemsound.ship_arrival_departure", this._boat);
        this.TALKING_SOUND = new PlaySound(0, "itemsound.ship_arrival_departure", this._boat);
        this.GIRAN_SOUND_LEAVE_5MIN = new PlaySound(0, "itemsound.ship_5min", this._boat);
        this.GIRAN_SOUND_LEAVE_1MIN = new PlaySound(0, "itemsound.ship_1min", this._boat);
    ...
    public static void load() {
        Boat boat = BoatManager.getInstance().getNewBoat(2, 48950, 190613, -3610, 60800);
        if (boat != null) {
    ...
    public void run() {
        switch (this._cycle) {
            ...
            case 3:
                ...
                this._boat.payForRide(3946, 1, OUST_LOC_1);
            ...
            case 12:
                ...
                this._boat.broadcastPacket(this.TALKING_SOUND);
                this._boat.payForRide(3945, 1, OUST_LOC_2);
                this._boat.executePath(TALKING_TO_GIRAN);
                ThreadPool.schedule(this, 200000L);
                break;
            case 13:
