...
public class VillageMaster extends Folk {
        ...
        if (actualCommand.equalsIgnoreCase("create_clan")) {
            ...
            switch (cmdChoice) {
                ...
                case 1:
                    ...
                    if ((double) player.getInventoryLimit() * 0.8 <= (double) player.getInventory().getSize() || player.getWeightPenalty() > 2) {
                    ...
                    if (player.getSubClasses().size() >= Config.ALLOWED_SUBCLASS) {
                        ...
                        Set<ClassId> subsAvailable = this.getAvailableSubClasses(player);
                ...
                case 6:
                    ...
                    switch (paramOne) {
                        case 1 -> html.setFile("data/html/villagemaster/SubClass_ModifyChoice1.htm");
                        case 2 -> html.setFile("data/html/villagemaster/SubClass_ModifyChoice2.htm");
                        case 3 -> html.setFile("data/html/villagemaster/SubClass_ModifyChoice3.htm");
                        default -> html.setFile("data/html/villagemaster/SubClass_ModifyChoice.htm");
                    }
    ...
    public final boolean checkVillageMaster(int classId) {
        return this.checkVillageMaster(ClassId.VALUES[classId]);
    }
