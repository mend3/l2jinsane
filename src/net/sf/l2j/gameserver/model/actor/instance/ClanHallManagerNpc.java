...
public class ClanHallManagerNpc extends Merchant {
                ...
                if (actualCommand.equalsIgnoreCase("banish_foreigner")) {
                    ...
                    if (val.equalsIgnoreCase("tele")) {
                        ...
                        if (chf == null) {
                            ...
                            String var10001 = this._clanHall.getLocation();
                            html.setFile("data/html/clanHallManager/tele" + var10001 + chf.getLvl() + ".htm");
                        }
                        ...
                        this.showBuyWindow(player, Integer.parseInt(st.nextToken()) + chf.getLvl() * 100000);
                        ...
                        if (val.equalsIgnoreCase("recovery")) {
                            if (st.hasMoreTokens()) {
                                ...
                                if (val.equalsIgnoreCase("hp_cancel")) {
                                    ...
                                    int cost;
                                    switch (percent) {
                                        case 20 -> cost = Config.CH_HPREG1_FEE;
                                        case 40 -> cost = Config.CH_HPREG2_FEE;
                                        case 80 -> cost = Config.CH_HPREG3_FEE;
                                        case 100 -> cost = Config.CH_HPREG4_FEE;
                                        case 120 -> cost = Config.CH_HPREG5_FEE;
                                        case 140 -> cost = Config.CH_HPREG6_FEE;
                                        case 160 -> cost = Config.CH_HPREG7_FEE;
                                        case 180 -> cost = Config.CH_HPREG8_FEE;
                                        case 200 -> cost = Config.CH_HPREG9_FEE;
                                        case 220 -> cost = Config.CH_HPREG10_FEE;
                                        case 240 -> cost = Config.CH_HPREG11_FEE;
                                        case 260 -> cost = Config.CH_HPREG12_FEE;
                                        default -> cost = Config.CH_HPREG13_FEE;
                                    }

                                    html.replace("%cost%", cost + "</font> adenas / " + Config.CH_HPREG_FEE_RATIO / 86400000L + " day</font>)");
                                    ...
                                    int cost;
                                    switch (percent) {
                                        case 5 -> cost = Config.CH_MPREG1_FEE;
                                        case 10 -> cost = Config.CH_MPREG2_FEE;
                                        case 15 -> cost = Config.CH_MPREG3_FEE;
                                        case 30 -> cost = Config.CH_MPREG4_FEE;
                                        default -> cost = Config.CH_MPREG5_FEE;
                                    }

                                    html.replace("%cost%", cost + "</font> adenas / " + Config.CH_MPREG_FEE_RATIO / 86400000L + " day</font>)");
                                    ...
                                    int cost;
                                    switch (percent) {
                                        case 5 -> cost = Config.CH_EXPREG1_FEE;
                                        case 10 -> cost = Config.CH_EXPREG2_FEE;
                                        case 15 -> cost = Config.CH_EXPREG3_FEE;
                                        case 25 -> cost = Config.CH_EXPREG4_FEE;
                                        case 35 -> cost = Config.CH_EXPREG5_FEE;
                                        case 40 -> cost = Config.CH_EXPREG6_FEE;
                                        default -> cost = Config.CH_EXPREG7_FEE;
                                    }

                                    html.replace("%cost%", cost + "</font> adenas / " + Config.CH_EXPREG_FEE_RATIO / 86400000L + " day</font>)");
                                ...
                                ClanHallFunction chfHp = this._clanHall.getFunction(3);
                                if (chfHp != null) {
                                    int var10002 = chfHp.getLvl();
                                    html.replace("%hp_recovery%", var10002 + "%</font> (<font color=\"FFAABB\">" + chfHp.getLease() + "</font> adenas / " + Config.CH_HPREG_FEE_RATIO / 86400000L + " day)");
                                ...
                                ClanHallFunction chfExp = this._clanHall.getFunction(5);
                                if (chfExp != null) {
                                    int var121 = chfExp.getLvl();
                                    html.replace("%exp_recovery%", var121 + "%</font> (<font color=\"FFAABB\">" + chfExp.getLease() + "</font> adenas / " + Config.CH_EXPREG_FEE_RATIO / 86400000L + " day)");
                                ...
                                ClanHallFunction chfMp = this._clanHall.getFunction(4);
                                if (chfMp != null) {
                                    int var122 = chfMp.getLvl();
                                    html.replace("%mp_recovery%", var122 + "%</font> (<font color=\"FFAABB\">" + chfMp.getLease() + "</font> adenas / " + Config.CH_MPREG_FEE_RATIO / 86400000L + " day)");
                            ...
                            if (st.hasMoreTokens()) {
                                ...
                                if (val.equalsIgnoreCase("item_cancel")) {
                                    ...
                                    int cost;
                                    switch (stage) {
                                        case 1 -> cost = Config.CH_ITEM1_FEE;
                                        case 2 -> cost = Config.CH_ITEM2_FEE;
                                        default -> cost = Config.CH_ITEM3_FEE;
                                    }

                                    html.replace("%cost%", cost + "</font> adenas / " + Config.CH_ITEM_FEE_RATIO / 86400000L + " day</font>)");
                                    ...
                                    int cost;
                                    switch (stage) {
                                        case 1 -> cost = Config.CH_SUPPORT1_FEE;
                                        case 2 -> cost = Config.CH_SUPPORT2_FEE;
                                        case 3 -> cost = Config.CH_SUPPORT3_FEE;
                                        case 4 -> cost = Config.CH_SUPPORT4_FEE;
                                        case 5 -> cost = Config.CH_SUPPORT5_FEE;
                                        case 6 -> cost = Config.CH_SUPPORT6_FEE;
                                        case 7 -> cost = Config.CH_SUPPORT7_FEE;
                                        default -> cost = Config.CH_SUPPORT8_FEE;
                                    }

                                    html.replace("%cost%", cost + "</font> adenas / " + Config.CH_SUPPORT_FEE_RATIO / 86400000L + " day</font>)");
                                    ...
                                    int cost;
                                    switch (stage) {
                                        case 1 -> cost = Config.CH_TELE1_FEE;
                                        default -> cost = Config.CH_TELE2_FEE;
                                    }

                                    html.replace("%cost%", cost + "</font> adenas / " + Config.CH_TELE_FEE_RATIO / 86400000L + " day</font>)");
                                ...
                                if (chfTel != null) {
                                    int var123 = chfTel.getLvl();
                                    html.replace("%tele%", "- Stage " + var123 + "</font> (<font color=\"FFAABB\">" + chfTel.getLease() + "</font> adenas / " + Config.CH_TELE_FEE_RATIO / 86400000L + " day)");
                                ...
                                if (chfSup != null) {
                                    int var124 = chfSup.getLvl();
                                    html.replace("%support%", "- Stage " + var124 + "</font> (<font color=\"FFAABB\">" + chfSup.getLease() + "</font> adenas / " + Config.CH_SUPPORT_FEE_RATIO / 86400000L + " day)");
                                ...
                                if (chfCreate != null) {
                                    int var125 = chfCreate.getLvl();
                                    html.replace("%item%", "- Stage " + var125 + "</font> (<font color=\"FFAABB\">" + chfCreate.getLease() + "</font> adenas / " + Config.CH_ITEM_FEE_RATIO / 86400000L + " day)");
                            ...
                            if (st.hasMoreTokens()) {
                                ...
                                if (val.equalsIgnoreCase("curtains_cancel")) {
                                    ...
                                    int cost;
                                    switch (stage) {
                                        case 1 -> cost = Config.CH_CURTAIN1_FEE;
                                        default -> cost = Config.CH_CURTAIN2_FEE;
                                    }

                                    html.replace("%cost%", cost + "</font> adenas / " + Config.CH_CURTAIN_FEE_RATIO / 86400000L + " day</font>)");
                                    ...
                                    int cost;
                                    switch (stage) {
                                        case 1 -> cost = Config.CH_FRONT1_FEE;
                                        default -> cost = Config.CH_FRONT2_FEE;
                                    }

                                    html.replace("%cost%", cost + "</font> adenas / " + Config.CH_FRONT_FEE_RATIO / 86400000L + " day</font>)");
                                ...
                                if (chfCurtains != null) {
                                    int var126 = chfCurtains.getLvl();
                                    html.replace("%curtain%", "- Stage " + var126 + "</font> (<font color=\"FFAABB\">" + chfCurtains.getLease() + "</font> adenas / " + Config.CH_CURTAIN_FEE_RATIO / 86400000L + " day)");
                                ...
                                if (chfPlateform != null) {
                                    int var127 = chfPlateform.getLvl();
                                    html.replace("%fixture%", "- Stage " + var127 + "</font> (<font color=\"FFAABB\">" + chfPlateform.getLease() + "</font> adenas / " + Config.CH_FRONT_FEE_RATIO / 86400000L + " day)");
                    ...
                    html.replace("%mp%", (int) this.getStatus().getCurrentMp());
                    html.replace("%objectId%", this.getObjectId());
                    player.sendPacket(html);
    ...
    protected int validateCondition(Player player) {
        if (this._clanHall == null) {
            ...
            return this._clanHall.getOwnerId() == player.getClanId() ? 3 : 0;
        } else {
            return 1;
        }
    }
