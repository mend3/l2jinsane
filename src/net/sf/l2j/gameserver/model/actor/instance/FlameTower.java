    ...
    public boolean doDie(Creature killer) {
        ...
        if (this.getCastle() != null) {
            if (this._zoneList != null && this._upgradeLevel != 0) {
                this.getCastle().getSiege().announceToPlayers(SystemMessage.getSystemMessage(SystemMessageId.A_TRAP_DEVICE_HAS_BEEN_STOPPED), false);
            }
            ...
            try {
                ...
                this.getCastle().getSiege().getDestroyedTowers().add(tower);
            } catch (Exception e) {
