        ...
        if (player != null) {
            if (Config.ALLOW_CLASS_MASTERS) {
                ...
                if (command.startsWith("1stClass")) {
                    ClassMaster.showHtmlMenu(player, this.getObjectId(), 1);
                } else if (command.startsWith("2ndClass")) {
                    ClassMaster.showHtmlMenu(player, this.getObjectId(), 2);
                } else if (command.startsWith("3rdClass")) {
                    ClassMaster.showHtmlMenu(player, this.getObjectId(), 3);
