        ...
        if (command.startsWith("OlympiadNoble")) {
            ...
            switch (val) {
                ...
                case 2:
                    ...
                    int classed = OlympiadManager.getInstance().getRegisteredClassBased().size();
                ...
                case 5:
                    ...
                    break;
                case 6:
                    String var10001 = Olympiad.getInstance().getNoblessePasses(player, false) > 0 ? "noble_settle.htm" : "noble_nopoints2.htm";
                    html.setFile("data/html/olympiad/" + var10001);
                    html.replace("%objectId%", this.getObjectId());
                    player.sendPacket(html);
                    break;
                case 7:
            ...
            switch (val) {
                ...
                case 3:
                    ...
                    for (OlympiadGameTask task : OlympiadGameManager.getInstance().getOlympiadTasks()) {
                        Object[] var22 = new Object[]{"<a action=\"bypass arenachange ", i, "\">Arena ", null, null};
                        ++i;
                        var22[3] = i;
                        var22[4] = "&nbsp;";
