...
public class DerbyTrackManagerNpc extends Folk {
    ...
    public void onBypassFeedback(Player player, String command) {
        if (command.startsWith("BuyTicket")) {
            ...
            NpcHtmlMessage html = new NpcHtmlMessage(this.getObjectId());
            html.setFile(this.getHtmlPath(this.getTemplate().getNpcId(), 5));

            for (int i = 0; i < 8; ++i) {
                int n = i + 1;
                html.replace("Mob" + n, DerbyTrackManager.getInstance().getRunnerName(i));
                double odd = DerbyTrackManager.getInstance().getOdds().get(i);
                html.replace("Odd" + n, odd > (double) 0.0F ? String.format(Locale.ENGLISH, "%.1f", odd) : "&$804;");
            }
            ...
            NpcHtmlMessage html = new NpcHtmlMessage(this.getObjectId());
            html.setFile(this.getHtmlPath(this.getTemplate().getNpcId(), 6));
            ...
            NpcHtmlMessage html = new NpcHtmlMessage(this.getObjectId());
            html.setFile(this.getHtmlPath(this.getTemplate().getNpcId(), 7));
            ...
            NpcHtmlMessage html = new NpcHtmlMessage(this.getObjectId());
            html.setFile(this.getHtmlPath(this.getTemplate().getNpcId(), 8));
            ...
            if (command.startsWith("CalculateWin")) {
                ...
                if (player.destroyItem("MonsterTrack", ticket, this, true)) {
                    player.addAdena("MonsterTrack", (int) ((double) bet * (lane == info.getFirst() + 1 ? info.getOddRate() : 0.01)), this, true);
                }
            ...
            if (command.equals("ViewHistory")) {
                ...
                NpcHtmlMessage html = new NpcHtmlMessage(this.getObjectId());
                html.setFile(this.getHtmlPath(this.getTemplate().getNpcId(), 9));
