...
public class RaidBossInfoInstance extends Folk {
        ...
        for (int bossId : infos) {
            ...
            if (template != null) {
                ...
                if (respawnTime <= System.currentTimeMillis()) {
                    ...
                    sb.append("<td width=\"110\" align=\"right\"><font color=\"FB5858\">Dead</font> " + var10001.format(var10002) + "</td>");
                    sb.append("</tr>");
                }
            }
        }
    ...
    private void showRaidBossDrop(Player player, int bossId, int pageId) {
        ...
        if (template != null) {
            ...
            sb.append("<td width=\"160\" align=\"center\"><a action=\"bypass -h npc_%objectId%_RaidBossInfo " + var10001 + "\">Return</a></td>");
            sb.append("</tr>");
            sb.append("</table>");
            sb.append("</center>");
            sb.append("</body>");
