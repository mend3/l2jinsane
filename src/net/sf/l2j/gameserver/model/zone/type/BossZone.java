...
public class BossZone extends ZoneType {
    ...
    private boolean _checkplayerCond;
    ...
    protected void onEnter(Creature character) {
        ...
        if (character instanceof Player player) {
            ...
            this._checkplayerCond = !player.isGM() && this._invadeTime != 0 && !Config.ALLOW_DIRECT_TP_TO_BOSS_ROOM;
    ...
    public List<Player> oustAllPlayers() {
        List<Player> players = getKnownTypeInside(Player.class);
        if (players.isEmpty())
            return players;
