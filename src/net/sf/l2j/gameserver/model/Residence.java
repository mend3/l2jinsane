...
public abstract class Residence {
    ...
    protected Residence(StatSet set) {
        ...
        _parentId = set.getInteger("parentId", -1);
        ...
        _location = set.getString("loc", _name);
    }
    ...
    public final int getDefaultBid() {
        return _set.getInteger("defaultBid", 50000000);
    }
    ...
    /**
     * @return the {@link List} of all {@link Door}s this {@link net.sf.l2j.gameserver.model.clanhall.ClanHall} owns.
     */
